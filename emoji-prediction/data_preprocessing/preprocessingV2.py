...
def keep_words_surrounding_emoji(row, num_of_words_before, num_of_words_after, index_to_word, word_to_embedding,
    ...
    new_column1_emb = [padded_words_emb[i - num_of_words_before + 1:i + num_of_words_after + 1] for i in
                       nonzero_indices]
...
def generate_train_dataframe(df, word_to_embedding, index_to_word, embedding_shape):
    ...
    for _, row in df.iterrows():
        new_col1_ix, new_col1_emb, new_col2 = keep_words_surrounding_emoji(row, num_of_words_before=2,
                                                                           num_of_words_after=2,
